...
- 2026-07-21 (later still) — Tony decided: characters = **bean-people ragdolls**; world = **bright Wii-clean**. `Docs/ContentPlan.md` added: full asset inventory (all free/CC0 sources named), bean build spec, UI kit + fonts, audio plan, art-pass schedule.
